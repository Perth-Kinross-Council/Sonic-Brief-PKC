...
export const env = {
  // Base URL for the app (root path or custom domain)
  VITE_BASE_URL: import.meta.env.VITE_BASE_URL ?? "/",

  // Authentication method: "legacy", "entra", or "both"
...
export const azureConfig = {
  isConfigured: () =>
    !!(env.VITE_AZURE_CLIENT_ID && env.VITE_AZURE_TENANT_ID && env.VITE_AZURE_BACKEND_SCOPE),
  isMissingConfig: () =>
    !env.VITE_AZURE_CLIENT_ID || !env.VITE_AZURE_TENANT_ID || !env.VITE_AZURE_BACKEND_SCOPE,
  getMissingVars: () => {
    const missing = [];
